...
<head>
    ...
    <meta name="description" content="GameVault — Gérez votre collection de jeux vidéo et organisez des sessions gaming avec vos amis.">
    <title>GameVault — La voûte des joueurs</title>
...
<header class="mobile-header" role="banner">
    ...
    <button class="mobile-header__btn" id="hamburger-btn" aria-label="Ouvrir le menu" aria-expanded="false" aria-controls="mobile-nav">
    ...
    <section class="section" aria-labelledby="sessions-title">
        ...
        <article class="session-card" role="listitem">
            ...
            <div class="session-card__action">
                <a href="/sessions.php?id=<?= htmlspecialchars($s['id']) ?>" class="btn btn--primary btn--sm">
                    Rejoindre
                </a>
            </div>
        </article>
